...
import com.example.easy_recycleview_library.BaseRecyclerView;
...
import com.guyuan.handlein.base.util.LogUtils;
 ...
 **/
public abstract class BaseListFragment<T, VB extends ViewDataBinding, VM extends BaseViewModel> extends BaseFragment<VB, VM> {
    ...
    private String emptyTip = TIP_NO_DATA;
