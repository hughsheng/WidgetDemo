...
public class ApiServiceModule extends BaseApiServiceModule implements HttpSettingImpl {
    ...
    @Provides
    @Named(BaseApiServiceModule.WITHOUT_CERTIFICATE)
    public OkHttpClient.Builder getDebugOkHttpClientBuilder(@Named(BaseApiServiceModule.WITHOUT_CERTIFICATE) SSLSocketFactory sslSocketFactory,
                                                            X509TrustManager x509TrustManager,
                                                            HttpLoggingInterceptor loggingInterceptor,
                                                            HeadInterceptor headInterceptor,
                                                            ResponseInterceptor responseInterceptor,
    ...
    @Provides
    @Named(BaseApiServiceModule.WITHOUT_CERTIFICATE)
    public Retrofit getDebugRetrofit(@Named(BaseApiServiceModule.WITHOUT_CERTIFICATE) OkHttpClient.Builder okHttpClient) {
