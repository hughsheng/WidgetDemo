...
import com.guyuan.handlein.base.ui.customizeview.autoscrollrecyclerview.AutoScrollAdapter;
import com.guyuan.handlein.base.ui.customizeview.autoscrollrecyclerview.AutoScrollRecyclerView;
import com.guyuan.handlein.base.ui.customizeview.autoscrollrecyclerview.MessageBean;
import com.guyuan.handlein.base.util.CommonUtils;
import com.guyuan.handlein.base.util.ConstantValue;
...
public class SmartControlView extends ConstraintLayout {
    ...
    protected void onFinishInflate() {
        ...
        initView();
        HandleInApplication.getInstance().startBackService(BackService.NOT_HANDLE_CONTROL_MESSAGE, null);
    }
        ...
        autoScrollAdapter.setListener(new AutoScrollAdapter.AutoScrollAdapterListener() {
            ...
            public void onClick(String url, String urlName) {
                if (url != null && urlName != null) {
                    ...
                    bundle.putString(KEY_TITLE, urlName);
