package com.guyuan.handlein.base.bean;
...
public class AppMenusBean implements Parcelable {
    ...
    private List<AppMenusBean> children;
    ...
    protected AppMenusBean(Parcel in) {
        ...
        this.children = new ArrayList<AppMenusBean>();
        in.readList(this.children, AppMenusBean.class.getClassLoader());
    }
    ...
    public List<AppMenusBean> getChildren() {
        return children;
    }

    public void setChildren(List<AppMenusBean> children) {
