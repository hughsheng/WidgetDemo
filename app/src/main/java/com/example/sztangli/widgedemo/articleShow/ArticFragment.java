...
import com.example.sztangli.widgedemo.databinding.FragmentArtivcleshowBinding;
...
public class ArticFragment extends BaseFragment<FragmentArtivcleshowBinding, BaseViewModel> {
    ...
    public void initialization() {
        binding.articleTv.setMovementMethod(ScrollingMovementMethod.getInstance());
        binding.articleTv.setText(Html.fromHtml("<head>\n" +
                "  <meta charset=\"utf-8\">\n" +
                ...
                "\n" +
                "  </body>\n" +
                "</html>\n", new MImageGetter(binding.articleTv, getContext()), null));
    }
